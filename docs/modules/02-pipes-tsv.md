# Module 9 — Advanced TSV Data Wrangling
...
```bash
mkdir -p ~/bioinfo-course/module09 && cd ~/bioinfo-course/module09
```
...
Generate the dataset once and save it directly to `grades.tsv`:
...
**Subject:** Bioinfo M9 Exit Ticket – <Your Name>
**Paste:**

- Your three one-liners (exact commands).
- The three answers (numbers / top 10 table).

**Next:** [Module 10 — RNA-seq Primer](05-rnaseq-primer.md)
